...
func newIncomingParam(param interface{}) *IncomingParam {
	rparam := &IncomingParam{
		value: param,
...
func (this *IncomingParam) parse(left, right string) int {
...
func (this *IncomingParam) getFromEllipsis(param string) bool {
...
func (this *IncomingParam) getFromArray(param string) bool {
...
func (this *IncomingParam) getFromWordList(param, left, right string) bool {
